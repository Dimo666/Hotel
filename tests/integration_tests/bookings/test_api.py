...
@pytest.mark.parametrize(
    ...
    [
        ...
        (1, "2024-08-06", "2024-08-15", 409),  # Ожидаем ошибку (например, пересечение дат)
...
async def test_add_booking(
    ...
    date_from,
    date_to,
    status_code,  # Параметры, передаваемые из списка выше
    db,
    authenticated_ac,  # Фикстуры: подключение к БД и авторизованный клиент
):
